...
=========
   ...
   +==============+=============+============================================+
   | Download     | PyPI        | https://pypi.python.org/pypi/pythonids     |
   +--------------+-------------+--------------------------------------------+
   |              | Sourceforge | https://sourceforge.net/projects/pythonids/|
   +--------------+-------------+--------------------------------------------+
   |              | github.com  | https://github.com/ArnoCan/pythonids/      |
   +--------------+-------------+--------------------------------------------+
   | Documents    | sourceforge | https://pythonids.sourceforge.io/          |
   +--------------+-------------+--------------------------------------------+
...
For help on extensions to standard options call online context-help:
   ...
   .. parsed-literal::
      ...
      python setup.py **--help-pythonids**
